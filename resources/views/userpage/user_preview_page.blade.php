                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                            {{ $user->name }} đã đóng góp
                        </div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                          {{ $user->achieveDetail->articleCount }} bài viết
                        </div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                          {{ $user->achieveDetail->discussionCount }} thảo luận
                        </div>
                    </div>
                    <div class="col-auto">
...
<div class="row mt-3">
    <div class="{!! $user->achieveDetail->articleCount == 0 ? 'd-none' : 'col-xl-4 col-lg-5' !!}">
    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <h4 class="small font-weight-bold">Tổng kinh nghiệm
          <span style="float:right">{{ $user->achieveDetail->exp }} / {{ $exp_to_next_level }}</span>
        </h4>
        <div class="progress mb-4 tooltip-o" data-tooltip-message="Bạn cần {{ $exp_to_next_level }} điểm để lên cấp tiếp theo">
          <div class="progress-bar" role="progressbar" style="width: {{ intval($user->achieveDetail->exp * 100 / $exp_to_next_level) }}%" aria-valuenow="{{ intval($user->achieveDetail->exp * 100 / $exp_to_next_level) }}" aria-valuemin="0" aria-valuemax="100"></div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col-12">
        <div class="card mb-4 shadow">
            ...
            <div class="collapse show" id="collapseCard" style="">
                <div class="card-body">
                    @foreach($user->achievements as $achieved)
